...
A análise é feita para cada um dos projetos, com o tamanho dos grupos recomendados $k \in \{1, 3, 5, 10\}$ já aplicados anteriormente, de forma a facilitar posteriores comparações. Os resultados são apresentados em tabelas distintas.
...
\hline
Node.js    & 1  & num\_comments          & 2.39               & 2.39                   & Não Paramétrico & 0.03016 & 100\%     \\

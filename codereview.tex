...
\section{INTRODUÇÃO}  %%Nesta linha, dentro de { }, digita-se em CAIXA ALTA, como apresentado aqui
...
\section{AVALIAÇÃO DA SOLUÇÃO}\label{chap:resultados}

  \subsection{Processo de Avaliação}

  \subsection{Apresentação dos resultados}\label{section:apresentacao}

  \subsection{Discussão dos resultados}\label{section:discussao}

\section{CONCLUSÃO}\label{chap:conclusao}

  \subsection{Ameaças}\label{section:ameacas}

  \subsection{Trabalhos futuros}\label{section:trabalhos_futuros}

  \subsection{Considerações finais}\label{section:consideracoes_finais}

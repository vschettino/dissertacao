...
% \coorientador[Coorientador:]{Victor Ströele} %% Retirar o primeiro ``%'' desta linha se tiver coorientador. Se precisar, troque por [Cooorientadora:].
...
\finalcatalog{1. revisão de código. 2. desenvolvimento distribuido. 3. sistemas de recomendação. I. Pereira Araújo, Marco Antônio, orient. II. T\'itulo.} %% Aqui fica escrito a palavra ``T\'itulo'' mesmo, nao o do trabalho. Se tiver coorientador, os dados ficam depois dos dados
...
\begin{epigrafe}
    \vspace*{\fill}
	\begin{flushright}
    \textit{Não quero lhe falar meu grande amor \\
...
\begin{resumo}
A revisão de código é uma das principais técnicas de diminuição de defeitos de software.

Palavras-chave: Revisão de código. Desenvolvimento distribuído. Sistemas de Recomendação. %finalizadas por ponto e inicializadas por letra maiuscula.
